 ...
 */
	public function testCreate() {
		...
		$audit = ClassRegistry::init( 'Audit' )->find('first', array(
			'recursive'  => -1,
			'conditions'        => array(
				'Audit.event'     => 'CREATE',
				'Audit.model'     => 'Article',
		...
		$deltas = ClassRegistry::init( 'AuditDelta' )->find('all', array(
			'recursive' => -1,
 ...
 */
	public function testSaveAll() {
		...
		$article_audit = ClassRegistry::init( 'Audit' )->find('first', array(
			'recursive'  => -1,
			'conditions'        => array(
				'Audit.event'     => 'CREATE',
				'Audit.model'     => 'Article',
		...
		$author_audit = ClassRegistry::init( 'Audit' )->find('first', array(
			'recursive'  => -1,
			'conditions'        => array(
				'Audit.event'     => 'CREATE',
				'Audit.model'     => 'Author',
		...
		$audits = ClassRegistry::init( 'Audit' )->find('all', array(
			'conditions'        => array(
				'Audit.event'     => 'CREATE',
				'Audit.model'     => 'Article',
			),
 ...
 */
	public function testEdit() {
		...
		$new_article = array(
			'Article' => array(
				...
				'author_id'     => 1,
				'title'         => 'First Test Article',
				'body'          => 'First Test Article Body','ignored_field' => 1,
				'published'     => 'N',
			),
		);
		...
		$audit_records = $this->Audit->find('all', array(
			'recursive' => 0,
			'conditions' => array(
				'Audit.model' => 'Article',
				'Audit.entity_id' => $this->Article->getLastInsertId()
		...
		$delta_records = $this->AuditDelta->find('all', array(
			'recursive' => -1,
		...
		$last_audit = $this->Audit->find('first', array(
	...
	public function testIgnoredField() {
		...
		$last_audit = $this->Audit->find('count', array(
			'contain'    => array( 'AuditDelta' ),
			'conditions' => array(
				'Audit.event'     => 'EDIT',
				'Audit.model'     => 'Article',
	...
	public function testDelete() {
		...
		$last_audit = $this->Audit->find('all', array(
